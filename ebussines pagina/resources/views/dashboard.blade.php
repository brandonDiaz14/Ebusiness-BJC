    ...
    <x-app-layout>
        <x-slot name="header" >
            <div style="border-radius: 10px;  position: relative; margin: 10px; text-align: center;">
                ...
                <div style="margin:5px;text-align: right; width: 10%;">
                    <x-dropdown style>
                        <x-slot name="trigger">
        ...
        <div class="container" >
            ...
            @if($contador == 4)
                <div style="border-radius: 10px; display: flex; justify-content: center; background-color: black; position: relative; margin: 10px;">
                    <div style="position: absolute; top: 10px; left: 50%; transform: translateX(-50%); z-index: 1;">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight" style="color: black;">Encuéntranos</h2>
                    </div>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3976.4944022814207!2d-74.10548368255616!3d4.683796099999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f9b6b0a37d83d%3A0xf1859530a183293c!2sCra.%2076%20%2366-21%2C%20Bogot%C3%A1!5e0!3m2!1ses-419!2sco!4v1654031793807!5m2!1ses-419!2sco" width="800" height="250" style="border:0; margin: 10px; border-radius: 10px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            @endif
                ...
                @endforeach
                    ...
                    <div class="card-body" style="border-radius: 20px; position: relative;">
                        <div style="text-align: center;">
                            <h2 class="display-5">{{ $produ->Nom_produ }}</h2>
                            ...
                            <form action="{{route('guardar.carrito')}}" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary" style="color: black;">Agregar Carrito</button>
